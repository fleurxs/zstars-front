  ...
  return (
    <html lang="ru">
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: `
              ...
              })(window, document,'script','https://mc.webvisor.org/metrika/tag_ww.js?id=105972743', 'ym');

              ym(105972743, 'init', {ssr:true, webvisor:true, clickmap:true, ecommerce:"dataLayer", accurateTrackBounce:true, trackLinks:true});
            `,
          }}
        />
        {/* /Yandex.Metrika counter */}
      ...
      <body className={`${inter.className} ${inter.variable} antialiased bg-black text-white`}>
        ...
        <noscript>
          <div>
            <img src="https://mc.yandex.ru/watch/105972743" style="position:absolute; left:-9999px;" alt="" />
          </div>
        </noscript>
        {/* /Yandex.Metrika counter */}
