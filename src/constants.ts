...
<p>В Telegram подарки могут быть не только "декором", но и <strong>коллекционными</strong>: их можно пересылать или передавать, а часть механик связана с блокчейном TON. Telegram официально писал про <strong>collectible gifts</strong> в обновлении начала 2025 года. (<a href="https://telegram.org/blog/collectible-gifts-and-more" target="_blank" rel="noopener noreferrer">Telegram</a>)</p>
<p>Также Telegram описывает техническую механику подарков и конвертации в Stars в документации API: подарок можно <strong>конвертировать в Stars</strong>, но это уничтожает подарок. (<a href="https://core.telegram.org/api/gifts" target="_blank" rel="noopener noreferrer">Telegram Core</a>)</p>
<p style="margin: 32px 0;"></p>
<h2>Почему новые подарки чаще перестали давать профит</h2>
<h3>1) Перенасыщение: редкость размазывается, ликвидность падает</h3>
<p>Когда коллекций становится больше, деньги и внимание покупателей распределяются между множеством вариантов. Итог простой:</p>
<ul>
...
<ul>
  <li><code>convert_stars</code> будет меньше, чем цена покупки подарка в Stars (<code>stars</code>). (<a href="https://core.telegram.org/api/gifts" target="_blank" rel="noopener noreferrer">Telegram Core</a>)</li>
  <li><code>convert_stars</code> может быть равен <code>stars</code> только если подарок куплен за "недавно купленные Stars", иначе — меньше. (<a href="https://core.telegram.org/constructor/starGift" target="_blank" rel="noopener noreferrer">Telegram Core</a>)</li>
</ul>
...
<p>Про "85%" как фиксированный курс конвертации я сказать не могу — в официальной документации Telegram это не дано как постоянное правило. Если где-то в интерфейсе или переводах всплывает "85%", без привязки к официальной спецификации это нельзя считать универсальным финансовым условием. (<a href="https://core.telegram.org/constructor/starGift" target="_blank" rel="noopener noreferrer">Telegram Core</a>)</p>
...
<p>Если рассматривать подарки как трейдинг, вам критично смотреть на вторичную ликвидность и историю сделок. На рынке TON один из самых известных NFT-маркетплейсов — <strong>Getgems</strong>. (<a href="https://getgems.io/" target="_blank" rel="noopener noreferrer">Getgems</a>)</p>
<p style="margin: 32px 0;"></p>
...
<ol>
  ...
  <li><strong>План выхода:</strong>
    <ul>
      <li>понимаете, что конвертация в Stars может быть с дисконтом; (<a href="https://core.telegram.org/api/gifts" target="_blank" rel="noopener noreferrer">Telegram Core</a>)</li>
...
<p style="margin: 32px 0;"></p>
<h2>Итог</h2>
<p>Новые подарки в Telegram в декабре 2025 года чаще не дают денег, потому что рынок стал плотным: больше коллекций, выше конкуренция, а "выход в Stars" по механике обычно хуже номинала. (<a href="https://core.telegram.org/api/gifts" target="_blank" rel="noopener noreferrer">Telegram Core</a>)</p>
